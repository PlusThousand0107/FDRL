...
dist_poly=np.load('FL_DQN_Fed_AggPer_1_(2)__mean_reward.npy')
central_poly=np.load('FL_DPG_Fed_AggPer_1_(1)__mean_reward.npy')
FL_poly_agg1=np.load('FL_PPO___Epochs_5_Eps_0.05_AggPer_1_Batch_32_(4)__mean_reward.npy')
FL_poly_agg10=np.load('FL_PPO___Epochs_5_Eps_0.1_AggPer_1_Batch_32_(4)__mean_reward.npy')
FL_poly_agg100=np.load('FL_PPO___Epochs_5_Eps_0.15_AggPer_1_Batch_32_(4)__mean_reward.npy')
FL_poly_agg1000=np.load('FL_PPO___Epochs_5_Eps_0.2_AggPer_1_Batch_32_(4)__mean_reward.npy')
...
plt.title('Aggregation Period = 1', fontsize=22)

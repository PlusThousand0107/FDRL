...
if __name__ == '__main__':
    ...
    file_name="Global_Aggr_9Cluster_FL_PPO___Epochs_"+str(Epochs)+"_Eps_"+str(Eps)+"_AggPer_"+str(AggPer)+"_Batch_"+str(batch_size)+"_("+str(Num)+")"
    ...
    for k in range(max_episode):
        ...
        if k % interval == 0: 
            ...
            if reward > 1.55 :
                ...
                # global_agent_1.save_models("models_param/PPO/"+file_name+"/"+file_name+"_global_agent1__("+str(cnt)+")")
                # global_agent_2.save_models("models_param/PPO/"+file_name+"/"+file_name+"_global_agent2__("+str(cnt)+")")
                # global_agent_3.save_models("models_param/PPO/"+file_name+"/"+file_name+"_global_agent3__("+str(cnt)+")")
                # global_agent_4.save_models("models_param/PPO/"+file_name+"/"+file_name+"_global_agent4__("+str(cnt)+")")
                # global_agent_5.save_models("models_param/PPO/"+file_name+"/"+file_name+"_global_agent5__("+str(cnt)+")")
                # global_agent_6.save_models("models_param/PPO/"+file_name+"/"+file_name+"_global_agent6__("+str(cnt)+")")
                # global_agent_7.save_models("models_param/PPO/"+file_name+"/"+file_name+"_global_agent7__("+str(cnt)+")")
                # global_agent_8.save_models("models_param/PPO/"+file_name+"/"+file_name+"_global_agent8__("+str(cnt)+")")
                # global_agent_9.save_models("models_param/PPO/"+file_name+"/"+file_name+"_global_agent9__("+str(cnt)+")")

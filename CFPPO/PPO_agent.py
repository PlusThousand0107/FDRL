...
class PPOAgent():
    ...
    def update(self, transition_dict, batch_size):
        ...
        for _ in range(self.epochs):
            ...
            surr2 = T.clamp(ratio, 1 - self.eps,1 + self.eps) * tensor_batch_advantage  # 截斷
    ...
    def get_loss(self):
        return np.array(self.actor_loss_hist), np.array(self.critic_loss_hist)
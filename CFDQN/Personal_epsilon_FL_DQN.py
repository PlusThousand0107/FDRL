...
if __name__ == '__main__':
    ...
    method="Personal_beta05_replace500_init05_end4500_seed11"
    ...
    path = os.path.join('models_param/DQN/'+method, directory) 
    os.mkdir(path)
    ...
    for k in range(max_episode):
        ...
        if k % interval == 0: 
            ...
            if reward > max_reward:
                ...
                for n in range(num_of_agents):
                    agent=Agents_list[n]
                    agent.save_models('models_param/DQN/'+method+'/'+directory+'/'+file_name+'_index_'+str(n)+'.pth')

                global_agent.save_models('models_param/DQN/'+method+'/'+directory+'/'+file_name+'.pth')

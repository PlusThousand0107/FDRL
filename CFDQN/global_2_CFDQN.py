...
if __name__ == '__main__':
    ...
    file_name="Global_Aggr_2Cluster_FL_DQN_Fed_AggPer_"+str(AggPer)+"_("+str(Num)+")"
    ...
    for k in range(max_episode):
        ...
        if k % AggPer == 0:
            ...
            for kd in global_dict_G.keys():
                global_dict_G[kd] = torch.stack([Agents_list[n].q_eval.state_dict()[kd] for n in range(2)], 0).mean(0)

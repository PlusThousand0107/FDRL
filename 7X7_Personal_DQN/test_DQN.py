...
if choice==1: # Central
    ...
    folder='7X7_Ensemble_Personal_beta05'
    ...
    for AggPerNum in range(len(AggPer)):
        for PG in range(len(P)):
            ...
            for i in range(num_of_agents):
                Agents_list[i].load_models('7X7_Personal_DQN/test/models/Personal_DQN/'+folder+'/AggPer'+str(AggPer[AggPerNum])+'_P'+str(P[PG])+'_G'+str(G[PG])+'_('+str(N)+')/'+folder+'_FL_DQN_Fed_AggPer_'+str(AggPer[AggPerNum])+'__P'+str(P[PG])+'_G'+str(G[PG])+'_('+str(N)+')_index_'+str(n)+"__("+str(cnt)+")"+'.pth')

            dqn_agent.load_models('7X7_Personal_DQN/test/models/Personal_DQN/'+folder+'/AggPer'+str(AggPer[AggPerNum])+'_P'+str(P[PG])+'_G'+str(G[PG])+'_('+str(N)+')/'+folder+'_FL_DQN_Fed_AggPer_'+str(AggPer[AggPerNum])+'__P'+str(P[PG])+'_G'+str(G[PG])+'_('+str(N)+')'+"__("+str(cnt)+")"+'.pth')

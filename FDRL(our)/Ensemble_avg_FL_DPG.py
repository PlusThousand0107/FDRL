...
if __name__ == '__main__':
    ...
    file_name=method+"_FL_DPG_Fed_AggPer_"+str(AggPer)+"_("+str(Num)+")"
    ...
    for k in range(max_episode):
        ...
        if k % AggPer == 0:
            ...
            #weights=[reward_lists_of_list[j][-1] for j in range(num_of_agents)]
        ...
        if k % interval == 0: 
            ...
            if reward > max_reward:
                ...
                global_agent.save_model('models_param/DPG/'+file_name+'.pth')

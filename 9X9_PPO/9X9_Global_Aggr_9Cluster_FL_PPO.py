...
if __name__ == '__main__':
    ...
    n1=[0,3,6,28,31,34] 
    n2=[1,4,7,29,32,35,55,58,61] 
    n3=[2,5,8,27,30,33,56,59,62] 
    n4=[9,12,15,38,41,44,63,66,69] 
    n5=[10,13,16,36,39,42,64,67,70]
    n6=[11,14,17,37,40,43,65,68,71] 
    n7=[18,21,24,46,49,52,72,75,78] 
    n8=[19,22,25,47,50,53,73,76,79] 
    n9=[20,23,26,45,48,51,74,77,80] 
